...
def btn1_click():
    ...
    random_images.append("takahashi.png")
    ...
    canvas.create_image(a-368,30,image=photo1, anchor=tk.NW)
    ...
    canvas.create_image(a+142,30,image=photo3, anchor=tk.NW)
    ...
    canvas.create_image(142+a,360,image=photo4, anchor=tk.NW)
    ...
    canvas.create_image(142+a,690,image=photo5, anchor=tk.NW)
    ...
    canvas.create_image(a-368,690,image=photo7, anchor=tk.NW)
    ...
    canvas.create_image(a-368,360,image=photo8, anchor=tk.NW)
    print(random_images[7])
    for i in range(0,8):
        if random_images[i] == "takahashi.png":
            data[x] = i+1
...
def btn2_click():
    ...
    canvas.create_image(a-368,30,image=photo_w, anchor=tk.NW)
    canvas.create_image(a-112,30,image=photo_w, anchor=tk.NW)
    canvas.create_image(142+a,30,image=photo_w, anchor=tk.NW)
    canvas.create_image(a-368,360,image=photo_w, anchor=tk.NW)
    canvas.create_image(a-368,690,image=photo_w, anchor=tk.NW)
    canvas.create_image(a-112,690,image=photo_w, anchor=tk.NW)
    canvas.create_image(142+a,360,image=photo_w, anchor=tk.NW)
    canvas.create_image(142+a,690,image=photo_w, anchor=tk.NW)
    if x == 10:
        write_to_csv()
