...
def btn1_click():
    ...
    random_images.append("watabe.png")
    ...
    image = image.resize((300, 300)) # 画像のリサイズ
    photo1 = ImageTk.PhotoImage(image)
    canvas.create_image(a,30,image=photo1, anchor=tk.NW)
    ...
    canvas.create_image(350+a,30,image=photo2, anchor=tk.NW)
    ...
    canvas.create_image(700+a,30,image=photo3, anchor=tk.NW)
    ...
    canvas.create_image(700+a,360,image=photo4, anchor=tk.NW)
    ...
    canvas.create_image(700+a,690,image=photo5, anchor=tk.NW)
    ...
    canvas.create_image(350+a,690,image=photo6, anchor=tk.NW)
    ...
    canvas.create_image(a,690,image=photo7, anchor=tk.NW)
    ...
    canvas.create_image(a,360,image=photo8, anchor=tk.NW)
    print(random_images[7])
    for i in range(0,8):
        if random_images[i] == "watabe.png":
            data[x] = i+1
...
def btn2_click():
    ...
    canvas.create_image(a,30,image=photo_w, anchor=tk.NW)
    canvas.create_image(350+a,30,image=photo_w, anchor=tk.NW)
    canvas.create_image(700+a,30,image=photo_w, anchor=tk.NW)
    canvas.create_image(a,360,image=photo_w, anchor=tk.NW)
    canvas.create_image(a,690,image=photo_w, anchor=tk.NW)
    canvas.create_image(350+a,690,image=photo_w, anchor=tk.NW)
    canvas.create_image(700+a,360,image=photo_w, anchor=tk.NW)
    canvas.create_image(700+a,690,image=photo_w, anchor=tk.NW)
    if x == 10:
        write_to_csv()
